...
app.get('/sales/health-check', (req, res, next) => {
...
app.get('/sales/products/:productId', (req, res, next) => {
...
app.get('/sales/cart', (req, res, next) => {
...
app.post('/sales/cart', (req, res, next) => {
...
app.post('/sales/orders', (req, res, next) => {
...
app.delete('/sales/cartItems/:cartItemId', (req, res, next) => {
  const { cartId } = req.session;
  if (!cartId) {
    throw new ClientError('There is no cartId on this session.', 400);
  }
